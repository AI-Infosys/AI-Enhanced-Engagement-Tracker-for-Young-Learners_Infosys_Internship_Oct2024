...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            new_entry = pd.DataFrame({'Name': ['Vanshika'], 'Date': [date_str], 'Time': [time_str]})
    ...
    if recognition_count >= 5:
        ...
        df.to_excel('vanshika_attendence_save(2).xlsx', index=False)
...
if not df.empty:
    df.to_excel('vanshika_attendance.xlsx', index=False)
